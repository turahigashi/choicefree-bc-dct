import Mathdemo.Internal.CRat_iter45

/-!
# Conditional CReal quotient COF record

`CRat_iter45` closed the data-order layer once quotient representatives are
...
exactly the two extraction frontiers isolated by `CRat_iter44`/`CRat_iter45`. -/
