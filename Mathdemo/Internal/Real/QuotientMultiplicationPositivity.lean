import Mathdemo.Internal.Real.QuotientAbsoluteValueProducts

/-!
# Quotient multiplication positivity

`QuotientAbsoluteValueProducts` closed the absolute-value multiplication field.  This file closes
