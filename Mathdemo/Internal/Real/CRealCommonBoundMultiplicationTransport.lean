import Mathdemo.Internal.Real.CRealCommonBoundMultiplicationAssociativityEstimates

/-!
# CReal common-bound multiplication transport

The associativity estimate in `CRealCommonBoundMultiplicationAssociativityEstimates` is stated for products sampled at
