import Mathdemo.Internal.Real.RepresentativeDiagonalClosenessQuotientConvergence

/-!
# Representative closeness calculus for the diagonal frontier

`RepresentativeDiagonalClosenessQuotientConvergence` reduced the remaining completeness work to constructing
