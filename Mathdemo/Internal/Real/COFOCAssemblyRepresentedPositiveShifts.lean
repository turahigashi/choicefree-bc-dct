import Mathdemo.Internal.Real.PositiveShiftsRecoverGlobalRepresentatives

/-!
# COFOC assembly from represented positive shifts

`PositiveShiftsRecoverGlobalRepresentatives` showed that positive-order-data extraction plus represented
positive shifts recovers a global quotient representative selector.  This file
feeds that selector into the existing `COFOCAssemblyAfterPositiveOrderData` COFOC assembly path for the
