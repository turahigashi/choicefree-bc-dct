import Mathdemo.Internal.Real.CauchySequenceRepresentativesAuditPositiveData

/-!
# Representative scope of positive `ltQuotData`

`CauchySequenceRepresentativesAuditPositiveData` showed that even in the localized positive-data branch,
