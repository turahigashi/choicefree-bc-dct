import Mathdemo.Internal.CRat_iter46
...
`CRat_iter46` exposes two remaining inputs before the conditional quotient
...
/-- The conditional quotient `COF` package after `CRat_iter46`: all algebraic
