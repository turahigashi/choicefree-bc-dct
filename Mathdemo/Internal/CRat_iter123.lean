import Mathdemo.Internal.CRat_iter122

/-!
# Audit map: previous COF/COFO/COFOC names versus the RegularSeq surface

`CRat_iter122` chose the source-shaped RegularSeq surface as the practical
...
through the explicit adapter boundary recorded in `CRat_iter120`. -/
