import Mathdemo.Internal.CRat_iter121

/-!
# Decision report: RegularSeq surface versus previous quotient adapter

`CRat_iter121` exposed the source-shaped RegularSeq surface.  This file adds a
single decision report comparing it with the previous quotient adapter route from
`CRat_iter120`, together with a compact progress meter for the two routes.
-/
