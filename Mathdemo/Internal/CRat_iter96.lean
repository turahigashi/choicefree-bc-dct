import Mathdemo.Internal.CRat_iter95

/-!
# Cauchy-sequence representatives imply global representatives

`CRat_iter95` isolated a seemingly weaker representative principle:
...
So the `CRat_iter95` principle is a precise interface, but not a genuine
...
/-- For the rep-free decidable-order `COFO` from `CRat_iter93`, the
