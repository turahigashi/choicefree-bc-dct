import Mathdemo.Internal.CRat_iter28

/-!
# CReal multiplication completion frontier

`CRat_iter28` proves that bounded representative multiplication descends to the
...
`CRat_iter28` available as a concrete quotient operation.
...
/-- The closure data of `CRat_iter28` recovered from the completion obligations. -/
...
separate because zero/one/comm already descend in `CRat_iter28`, while
