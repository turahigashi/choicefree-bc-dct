import Mathdemo.Internal.CRat_iter109

/-!
# Nondecidable quotient COFOC route from selector data and inverse totalization

`CRat_iter109` separated the data-valued order layer from the live Prop-valued
`COF` interface.  Together with the `CRat_iter106` `PosEventually` selector,
...
inverse totalization datum from `CRat_iter108`.
-/
...
/-- The data-valued order package from `CRat_iter109`, specialized to global
