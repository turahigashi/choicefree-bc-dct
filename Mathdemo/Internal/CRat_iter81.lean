import Mathdemo.Internal.CRat_iter80

/-!
# Positive inverse field data for the conditional COF branch

`CRat_iter80` proves both inverse laws for the positive total selector:
...
expected by `CRat_iter65`, and then assembles the corresponding conditional
...
using the decidable total selector from `CRat_iter75`. -/
