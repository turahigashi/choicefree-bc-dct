import Mathdemo.Internal.CRat_iter94

/-!
# COFOC assembly from Cauchy-sequence representative data

`CRat_iter94` closed representation-carrying completeness for the
...
completed.  Given that data, the `CRat_iter94` completeness theorem assembles a
