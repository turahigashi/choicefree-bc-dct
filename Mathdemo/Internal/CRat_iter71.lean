import Mathdemo.Internal.CRat_iter70
...
* the exact reciprocal-difference identity from `CRat_iter68`;
* the bound-sensitive reciprocal index from `CRat_iter69`;
* the uniform reciprocal bound from `CRat_iter70`;
