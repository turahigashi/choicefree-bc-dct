import Mathdemo.Internal.CRat_iter111

/-!
# Faithful data-carrying scalar package for the CReal quotient route

`CRat_iter110` gives a live `BishopC.COFOC CRealQuot` only after a total
positive-inverse selector is supplied.  `CRat_iter111` separated the
